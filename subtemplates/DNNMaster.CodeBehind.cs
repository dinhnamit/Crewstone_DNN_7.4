...
#region ExecuteScriptsOnTarget
    ...
    public bool ExecuteScriptsOnTarget {
        get {
            return _executeScriptsOnTarget;
        }
        set {
            _executeScriptsOnTarget = value;
        }
    }
#endregion
...
#region StrippedTablePrefixes
    ...
    public string StrippedTablePrefixes {
        get {
            return this._strippedTablePrefixes;
        }
        set {
            this._strippedTablePrefixes = value;
        }
    }
#endregion
...
#region File IO Operations
    ...
    public string GetFirstTextField(TableSchema table) {
